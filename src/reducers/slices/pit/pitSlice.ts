...
function calculateTaxBrackets(taxableIncome: Decimal): TaxBracket[] {
  const brackets: TaxBracket[] = [
    ...
    },
    {
      ...
      to: new Decimal(10_000_000),
      rate: new Decimal(0.1),
      taxable: new Decimal(0),
      tax: new Decimal(0)
    },
    {
      from: new Decimal(10_000_000),
      to: new Decimal(18_000_000),
      rate: new Decimal(0.15),
      taxable: new Decimal(0),
      tax: new Decimal(0)
    },
    {
      from: new Decimal(18_000_000),
      to: new Decimal(32_000_000),
      rate: new Decimal(0.2),
      taxable: new Decimal(0),
      tax: new Decimal(0)
    },
    {
      from: new Decimal(32_000_000),
      to: new Decimal(52_000_000),
      rate: new Decimal(0.25),
      taxable: new Decimal(0),
      tax: new Decimal(0)
    },
    {
      from: new Decimal(52_000_000),
      to: new Decimal(80_000_000),
      rate: new Decimal(0.3),
      taxable: new Decimal(0),
      tax: new Decimal(0)
    },
    {
      from: new Decimal(80_000_000),
...
function calculateTaxTotal(brackets: TaxBracket[]) {
